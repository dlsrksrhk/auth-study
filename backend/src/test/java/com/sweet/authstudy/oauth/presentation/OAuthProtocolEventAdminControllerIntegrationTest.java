...
class OAuthProtocolEventAdminControllerIntegrationTest extends OAuthAdminTestSupport {
    ...
    @Test
    void tenant_filtered_cursor_is_stable_for_equal_timestamps_and_safe() throws Exception {
    ...
    @Test
    void invalid_filters_and_tenant_access_are_rejected() throws Exception {
