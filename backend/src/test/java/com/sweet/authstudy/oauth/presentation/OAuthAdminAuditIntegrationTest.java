...
class OAuthAdminAuditIntegrationTest extends OAuthAdminTestSupport {
    ...
    @Test
    void audit_storage_failure_rolls_back_client_creation() {
    ...
    @Test
    void audit_storage_failure_rolls_back_consent_and_grant_revocation() {
        consent();
    ...
    @Test
    void audit_storage_failure_rolls_back_client_changes_and_rotation() {
        var actor = new com.sweet.authstudy.authorization.AuthenticatedAccount(account.id(), company.id(), account.userId(), account.roles(), false);
    ...
    @Test
    void client_mutations_are_audited_without_secrets() throws Exception {
    ...
    @Test
    void public_client_revoke_secret_is_conflict_and_foreign_tenant_is_forbidden() throws Exception {
