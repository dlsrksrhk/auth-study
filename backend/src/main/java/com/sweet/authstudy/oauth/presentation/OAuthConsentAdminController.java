...
import static com.sweet.authstudy.oauth.presentation.OAuthAdminResponses.ConsentResponse;
...
public class OAuthConsentAdminController {
    ...
    public OAuthConsentAdminController(OAuthAdminService service, ActorContext actors) {
