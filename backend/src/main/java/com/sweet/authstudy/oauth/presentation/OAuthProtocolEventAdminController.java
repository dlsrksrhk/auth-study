...
import com.sweet.authstudy.shared.error.*;
...
public class OAuthProtocolEventAdminController {
    ...
    public OAuthProtocolEventAdminController(OAuthAdminService service,ActorContext actors) { this.service=service; this.actors=actors; }
    @GetMapping
    public CursorResponse<ProtocolEventResponse> list(@PathVariable String companyCode,@PathVariable String clientId,
        ...
        if(page!=0) throw new ApiException(ErrorCode.VALIDATION_FAILED,"Use cursor pagination for protocol events.");
