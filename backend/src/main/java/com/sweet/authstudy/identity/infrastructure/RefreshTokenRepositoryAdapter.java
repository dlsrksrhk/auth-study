...
public class RefreshTokenRepositoryAdapter implements RefreshTokenRepository {
    ...
    @Override
    public Optional<Long> findAccountIdByHash(String hash) {
    ...
    @Override
    public void revokeAllByAccountId(long accountId, Instant revokedAt) {
        repository.revokeAllByAccountId(accountId, revokedAt);
    }
}
