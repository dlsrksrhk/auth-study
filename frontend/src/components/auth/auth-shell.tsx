  ...
  return (
    <main className="grid min-h-screen bg-slate-100 lg:grid-cols-[minmax(0,1fr)_minmax(34rem,0.72fr)]">
      <section className="relative hidden overflow-hidden bg-slate-950 p-12 text-slate-100 lg:flex lg:flex-col lg:justify-between">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(20,184,166,0.17),transparent_38%),radial-gradient(circle_at_80%_80%,rgba(59,130,246,0.13),transparent_34%)]" />
