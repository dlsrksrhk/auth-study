...
export const auditApi = {
  list(companyCode: string, params: AuditListParams, signal?: AbortSignal) {
    ...
    return apiClient.request<PageResponse<AuditLog>>(`/api/v1/admin/companies/${resourceCode(companyCode, "회사 코드")}/audit-logs?${query}`, {signal});
  }
};
