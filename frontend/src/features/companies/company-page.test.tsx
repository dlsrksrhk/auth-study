...
describe("CompanyPage", () => {
  ...
  it.each([
    ...
    ["four positions", HttpResponse.json({
      ...emptyPage,
      content: defaultPositions.slice(0, 4),
      totalElements: 4,
      totalPages: 1
    })],
  ...
  it.each(["resolve", "reject"] as const)(
      ...
      async (lateOutcome) => {
        ...
        const companyAStarted = new Promise<void>((resolve) => {
          markCompanyAStarted = resolve;
        });
        const companyAFinished = new Promise<void>((resolve) => {
          markCompanyAFinished = resolve;
        });
